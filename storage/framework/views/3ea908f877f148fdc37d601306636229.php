...
unset($__errorArgs, $__bag); ?> id="name" placeholder="Nome do Usuário" autofocus>
...
unset($__errorArgs, $__bag); ?>  placeholder="Indique a senha">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-floating mb-4">
                                <input type="password" name="password_confirmation" id="password" class="form-control" <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <p class="text-center mb-0">Já tens a conta? <a href="<?php echo e(route ('login')); ?>">Entrar</a></p>
                        </form>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Vamos\AAMs\resources\views/auth/register.blade.php ENDPATH**/ ?>