            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(url('layers.update')); ?>"  method = "post">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
                            <div class="form-floating mb-3">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Nome" value="<?php echo e($data->name); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" name="category" class="form-control" id="category" placeholder="Categoria" value="<?php echo e($data->category); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" name="address" class="form-control" id="address" placeholder="Morada" value="<?php echo e($data->address); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <a href="<?php echo e(url('layers.index')); ?>" class="btn btn-success">Back</a>
                        </form>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\AAMs\resources\views/layers/edit.blade.php ENDPATH**/ ?>