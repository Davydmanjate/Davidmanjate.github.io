                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="<?php echo e(route ('login.action')); ?>" method = "post">
                            ...
                            <p class="text-center mb-0">Não tens conta? <a href="<?php echo e(route ('register')); ?>">  Registe-se</a></p>
                        </form>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Vamos\AAMs\resources\views/auth/login.blade.php ENDPATH**/ ?>