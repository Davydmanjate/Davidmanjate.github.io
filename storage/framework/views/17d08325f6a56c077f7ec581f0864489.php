                        ...
                        <div class="col-md-6">
                            ...
                            <select name="case_id" id="case_id" class="form-control" value="<?php echo e($data->case_id); ?>" required>
                                <option value="">Nome</option>
                                    ...
                                    <option value="<?php echo e($case->id); ?>" <?php echo e($case->id == $data->case_id? 'selected':''); ?>><?php echo e($case->name); ?></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="custum_id" id="custum_id" class="form-control" value="<?php echo e($data->custum_id); ?>" required>
                                ...
                                <?php $__currentLoopData = $custum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($custum->id); ?>" <?php echo e($custum->id == $data->custum_id? 'selected':''); ?>><?php echo e($custum->id); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php echo $__env->make('base.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AAMs\resources\views/avanco/edit.blade.php ENDPATH**/ ?>