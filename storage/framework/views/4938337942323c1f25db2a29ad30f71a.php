...
<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo e(asset('assets/img/adv.png')); ?>" rel="icon">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="<?php echo e(asset('assets/img/adv.png')); ?>" alt="" style="width: 50px; height: 50px;">
                ...
                <div class="navbar-nav w-100">
                    <a href="<?php echo e(route('home')); ?>" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Home</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Registos</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="<?php echo e(route('layer.ind')); ?>" class="dropdown-item">Advogados</a>
                            <a href="<?php echo e(route('custums.ind')); ?>" class="dropdown-item">Clientes</a>
					 ...
					 <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="<?php echo e(route('case.index')); ?>" class="dropdown-item">Eventos</a>
                            <a href="<?php echo e(route('avance.index')); ?>" class="dropdown-item">Processos</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="<?php echo e(route ('register')); ?>" class="dropdown-item">Cadastro</a>
                            <a href="<?php echo e(route ('logout')); ?>" class="dropdown-item">Sair</a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="<?php echo e(asset('img/advg.jpg')); ?>" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                            <a href="<?php echo e(route('case.index')); ?>" class="dropdown-item">Eventos</a>
                                    </div>
                                </div>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="<?php echo e(asset('assets/img/advg.jpg')); ?>" alt="" style="width: 40px; height: 40px;">
...
<?php /**PATH C:\xampp\htdocs\Vamos\AAMs\resources\views/base/header.blade.php ENDPATH**/ ?>